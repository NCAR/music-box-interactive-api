...
# change general conditions
	try:
		...
		input_keys(browser, ['conditions', 'general', 'chemistry time step'], '2')
		input_keys(browser, ['conditions', 'general', 'output time step'], '201')
...
# change species
	try:
		...
		dropdown_select(browser, ['conditions', 'initial', 'species 6 name'], "O3")
		input_keys(browser, ['conditions', 'initial', 'species 6 initial value'], "101")
		dropdown_select(browser, ['conditions', 'initial', 'species 6 units'], "mol cm-3")
...
# change temp and pressure
	try:
		...
		dropdown_select(browser, ['conditions', 'initial', 'temperature units'], "F")
		dropdown_select(browser, ['conditions', 'initial', 'pressure units'], "mbar")
