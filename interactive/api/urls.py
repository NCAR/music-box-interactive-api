...
urlpatterns = [
    ...
    path('api/compress-config', api.CompressConfiguration.as_view(), name='compress-config'),
    path('api/extract-config', api.ExtractConfiguration.as_view(), name='extract-config')
]
