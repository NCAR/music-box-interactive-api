...
class InitialConditionsForm(forms.Form):
    def __init__(self, *args, **kwargs):
        ...
        self.fields['temperature.units'] = forms.ChoiceField(choices=[('K', 'K'), ('C', 'C')], widget=forms.Select(attrs={'savebutton': 'initialsSave', 'class': 'form-control'}))
        ...
        self.fields['pressure.units'] = forms.ChoiceField(choices=[('atm', 'atm'), ('kPa', 'kPa'), ('bar', 'Bar')], widget=forms.Select(attrs={'savebutton': 'initialsSave', 'class': 'form-control'}))
